	...
	<form class="form-inline" method="post" name="frm" action="?com=customers&view=customers">
		...
		<div class="form grid">
			...
			<div class="row well-sm">
				<div class="col-sm-2"><label class="control-label" for="title">Title:</label></div><div class="col-sm-5"><input name="title" class="inputbox form-control" value="" required /></div>
			</div>
