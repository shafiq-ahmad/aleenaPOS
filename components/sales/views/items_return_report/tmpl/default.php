...
?><div class="com-head">
	<h3>Sales return report by Item#</h3>
</div>

<div class="form"><?php
?></div>
<div class="table-responsive"><div id="search-date-range">
		<form method="post" action="?com=sales&view=items_return_report" >
			<div>
	...
	<table id="salesReportItems" class="table table-bordered table-hover table-condenseds">
		<thead>
		<tr>
			<th>Item#</th><th>Category</th><th>Title</th><th>Unit</th><th>Price</th>
			<th>Return Qty</th><th>Total Return</th>
		</tr>
		</thead>
		<tfoot>
			<tr>
	...
	?>;
		...
		$.each(json_data, function(i, v) {
			...
			document.write('<td class="saleQty">'+eval(v.return_qty).toFixed(2)+'</td>');
