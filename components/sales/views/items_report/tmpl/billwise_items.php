...
<div class="table-responsive"><div id="search-date-range">
	...
	<table id="data-table" class="table salesReportItems">
		<thead>
			<tr>
				<th>Sr#</th><th>bill#</th><th>Items</th><th>Title</th><th>Cost Price</th><th>Sales Price</th><th>Discount</th>
...
$(document).ready(function(){
	...
	$('#data-table').DataTable({
		...
		// Update footer
		$( api.column(8).footer()).html(eval(total1).toFixed(2));
		$( api.column(9).footer()).html(eval(total2).toFixed(2));
