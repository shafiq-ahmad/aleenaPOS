...
<div class="table-responsive">
	...
	<table id="data-table" class="table">
		<thead>
		<tr>
			<th>ID</th><th>Supplier Name</th><th>Address</th><th>Contact Person</th><th>Actions</th>
		</tr>
		</thead>
		...
		?><tr <?php if($this->id==$row['id']){echo ' class="active"';} ?>><?php 
			...
			//echo '<td>' . $row['type_of_items'] . '</td>'; 
			$edit_link = "?com=suppliers&view=supplier&task=edit&id={$row['id']}";
			...
			//echo '<a href="' . $item_link . '" title="Items">Items</a>'; 
