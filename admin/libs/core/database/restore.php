<?php 
/**
 * This file contains the Restore_Database_MySQL class wich performs
...
$bak_path = SITE_PATH . DS . 'db_bak' . DS . 'mysql';
//echo $bak_path; exit;
...
/**
 * The Restore_Database_MySQL class
 */
class Restore_Database_MySQL {
    /**
